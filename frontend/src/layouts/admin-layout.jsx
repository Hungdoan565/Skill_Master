        ...
        <div className="flex flex-1 flex-col overflow-hidden w-full">
          ...
          <div className="relative z-[100] flex items-center bg-card border-b border-border shadow-sm dark:shadow-none h-16 md:h-auto md:block md:border-0 md:bg-transparent">
            ...
            <div className="flex-1 overflow-visible">
              <AdminHeader notificationBell={<NotificationBell {...notificationState} />} showCenterSwitcher />
            </div>
          </div>
          ...
          <main className="flex-1 overflow-auto">
            <div className={`min-h-full relative ${isDark ? 'bg-background' : 'bg-[#fff8f0]'}`}>
              {/* Light mode: Soft Warm Pastel Texture */}
              {!isDark && (
                <div
              ...
              {/* Dark mode: Subtle cool gradient */}
              {isDark && (
                <div
                  className="absolute inset-0 z-0 pointer-events-none"
                  style={{
              ...
              <div className="min-h-full p-8 lg:p-10 relative">
                <Outlet />
              </div>
            </div>
          </main>
