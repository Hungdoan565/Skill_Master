              ...
              {group.items.map((item) => {
                ...
                return (
                  <Link
                    ...
                    to={item.path}
                    className={cn(
                      'group/item flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-amber-500/50',
                      isActive
