...
const menuGroups = [
  ...
  },
  {
    ...
    title: 'TÀI CHÍNH',
    items: [
      { label: 'Học phí', icon: CreditCard, path: '/student/tuition' },
      { label: 'Thanh toán', icon: QrCode, path: '/student/payment' },
    ],
  },
  {
    id: 'documents',
    title: 'TÀI LIỆU',
    items: [
      { label: 'Chứng chỉ', icon: FileText, path: '/student/certificates' },
    ],
  },
];
...
export function StudentSidebar() {
  ...
  return (
    <aside className="flex h-screen w-64 flex-col bg-zinc-950 text-white">
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-600/0 via-emerald-600/5 to-teal-500/0 
