        ...
        <nav className="flex items-center justify-between h-24">
          ...
          <div className="hidden lg:flex items-center gap-8">
            ...
            <NavDropdown label="Liên hệ" className={navLinkClasses} isOpen={openDropdown === 'contact'} onToggle={() => handleDropdownToggle('contact')} onClose={closeDropdown}>
              <div className="w-[280px] p-2">
                <DropdownSection>
                  <DropdownItem icon={MessageCircle} title="Chat tư vấn" description="Hỗ trợ 8:00 - 21:00 hàng ngày" href="/contact" />
                  ...
                  <DropdownItem icon={Calendar} title="Đặt lịch học thử" description="Trải nghiệm miễn phí 1 buổi" href="/contact#booking" />
                </DropdownSection>
