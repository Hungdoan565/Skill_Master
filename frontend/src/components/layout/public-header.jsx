...
const MobileNavItem = ({ label, href, onClick }) => (
  <Link 
    to={href} 
    onClick={onClick}
    className="block px-4 py-3 text-sm font-medium text-zinc-700 hover:bg-stone-50"
  >
    {label}
  </Link>
);
...
// ============================================
// PUBLIC HEADER COMPONENT - Shared across all public pages
// ============================================
const PublicHeader = () => {
            ...
            <div className="py-4 space-y-2">
              ...
              {!isAuthenticated && (
                <div className="pt-4 px-4 space-y-2">
                  <Link to="/login" onClick={() => setMobileMenuOpen(false)} className="block w-full py-3 text-center text-sm font-medium text-zinc-700 
                                             border border-stone-200 rounded-full hover:bg-stone-50">
                    Đăng nhập
                  </Link>
                  <Link to="/register" onClick={() => setMobileMenuOpen(false)} className="block w-full py-3 text-center text-sm font-medium text-white 
