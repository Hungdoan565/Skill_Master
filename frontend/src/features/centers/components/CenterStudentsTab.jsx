                ...
                <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                    <div className="relative w-full sm:w-64">
                        ...
                        <Input
                            ...
                            className="pl-9 bg-gray-50 dark:bg-zinc-950 border-gray-200 dark:border-zinc-800 focus-visible:ring-fuchsia-500 rounded-xl"
                        />
                    </div>
                    ...
                    <select
                        ...
                        className="h-10 px-3 py-2 bg-gray-50 dark:bg-zinc-950 border border-gray-200 dark:border-zinc-800 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-fuchsia-500 text-foreground"
                    >
