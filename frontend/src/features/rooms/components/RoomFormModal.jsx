...
export function RoomFormModal({
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-5">
          ...
          <div className="grid grid-cols-5 gap-4">
            ...
            <div className="col-span-2">
              <div className="flex items-center justify-between">
                <Label className="text-slate-700 dark:text-gray-300 font-medium">Mã phòng</Label>
                {!editingRoom && (
                  <button
                    type="button"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <Label className="text-slate-700 dark:text-gray-300 font-medium">Loại phòng</Label>
              <select
                value={formData.room_type}
                onChange={(e) => onFieldChange('room_type', e.target.value)}
                className="w-full mt-1.5 px-3 py-2 bg-white dark:bg-gray-800 border border-slate-200 dark:border-gray-600 rounded-lg text-sm dark:text-gray-200 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
              >
            ...
            <div>
              <div className="flex items-center justify-between">
                <Label className="text-slate-700 dark:text-gray-300 font-medium">Sức chứa</Label>
                <button
                  type="button"
              ...
              <div className="relative mt-1.5">
                <div className="flex items-center gap-1">
                  ...
                  />
                  <span className="text-xs text-slate-400 dark:text-gray-500 ml-1">chỗ</span>
                </div>
              </div>
              {showCapacityHint && (
          ...
          <div>
            ...
            <select
              ...
              className={`w-full mt-1.5 px-3 py-2 bg-white dark:bg-gray-800 border rounded-lg text-sm dark:text-gray-200 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all ${validation.center_id ? 'border-red-300 dark:border-red-700' : 'border-slate-200 dark:border-gray-600'
                }`}
            >
          ...
          {/* Row 4: Thiết bị */}
          <div>
            <Label className="text-slate-700 dark:text-gray-300 font-medium mb-2 block">
              Thiết bị có sẵn
            </Label>
            <EquipmentSelector
          ...
          {/* Row 5: Trạng thái */}
          <div>
            <Label className="text-slate-700 dark:text-gray-300 font-medium">Trạng thái</Label>
                    ...
                    ${formData.status === opt.value
                      ? opt.value === 'active'
                        ...
                        : opt.value === 'maintenance'
                          ...
                          : 'border-slate-400 dark:border-gray-500 bg-slate-50 dark:bg-gray-700 text-slate-600 dark:text-gray-300'
          ...
          {/* Row 6: Ghi chú */}
          <div>
            <Label className="text-slate-700 dark:text-gray-300 font-medium">Ghi chú</Label>
            <textarea
              value={formData.notes}
              onChange={(e) => onFieldChange('notes', e.target.value)}
              placeholder="Thông tin thêm về phòng học..."
              rows={2}
              className="w-full mt-1.5 px-3 py-2 border border-slate-200 dark:border-gray-600 bg-white dark:bg-gray-800 dark:text-gray-200 rounded-lg text-sm resize-none focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all"
            />
          </div>
        </div>

        {/* Footer */}
        <div className="px-6 py-4 bg-slate-50 dark:bg-gray-800 border-t dark:border-gray-700 flex items-center justify-between shrink-0">
