...
function LargeStatCard({ title, value, description, trend, trendUp, icon: Icon, color = 'orange', onClick }) {
  const colorClasses = {
...
function SmallStatCard({ title, value, icon: Icon, alert = false, onClick }) {
  return (
    <div
      onClick={onClick}
