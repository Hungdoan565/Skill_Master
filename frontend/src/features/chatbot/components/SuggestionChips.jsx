    ...
    <div className="px-1">
      ...
      {chips.map((chip, index) => (
        <button
          ...
          className="rounded-full border border-border bg-white dark:bg-zinc-900 px-3 py-1.5 text-xs text-foreground transition-all hover:bg-primary/10 hover:border-primary/30 animate-in fade-in duration-200"
