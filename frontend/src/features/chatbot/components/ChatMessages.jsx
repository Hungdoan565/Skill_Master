    ...
    <div className="relative flex-1 overflow-hidden">
      ...
      {showScrollButton && (
        <button
          ...
          className="absolute bottom-2 left-1/2 -translate-x-1/2 flex items-center gap-1 rounded-full bg-white dark:bg-zinc-900 border border-border px-3 py-1.5 text-xs text-muted-foreground shadow-md transition-all hover:bg-muted animate-in fade-in slide-in-from-bottom-2 duration-200"
        >
