        ...
        <div className="group relative overflow-hidden rounded-xl bg-amber-50 dark:bg-amber-500/10 border border-amber-200 dark:border-amber-500/20 shadow-sm p-4 sm:p-5 transition-all hover:bg-amber-100 dark:hover:bg-amber-500/15">
          ...
          <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Button 
              ...
              className="border-amber-500/30 text-amber-700 dark:text-amber-500 hover:bg-amber-500/20 bg-card shadow-sm whitespace-nowrap"
            >
                ...
                {stats.topTypes.map((type, i) => {
                  ...
                  return (
                    <div key={type.id || i} className="group relative">
                      ...
                      {/* Progress bar */}
                      <div className="h-2.5 w-full bg-muted overflow-hidden rounded-full ml-[42px] shadow-inner" style={{ width: 'calc(100% - 42px)' }}>
                        <div 
