      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="relative flex-1 min-w-[200px] max-w-[320px]">
          ...
          <Input
            ...
            className="pl-9 bg-background border-border/50 shadow-sm focus-visible:ring-1 focus-visible:border-primary transition-all"
          />
        </div>

        {/* Type Filter */}
        <Select value={selectedType || 'all'} onValueChange={handleTypeChange}>
          <SelectTrigger className="w-[180px] bg-background border-border/50 shadow-sm transition-all focus:ring-1">
        ...
        <Select value={filters?.status || 'all'} onValueChange={handleStatusChange}>
          <SelectTrigger className="w-[160px] bg-background border-border/50 shadow-sm transition-all focus:ring-1">
        ...
        <div className="flex items-center bg-background rounded-md border border-border/50 shadow-sm overflow-hidden h-9 px-1 focus-within:ring-1 focus-within:ring-ring focus-within:border-primary transition-all">
