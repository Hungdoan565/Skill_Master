  ...
  return (
    <div className="space-y-6 h-full flex flex-col">
      <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-5 flex items-start gap-4 shadow-sm relative overflow-hidden">
        ...
        <div className="h-12 w-12 bg-background rounded-full flex items-center justify-center border border-amber-500/20 shadow-sm shrink-0 z-10">
                ...
                render={({ field }) => (
                  <label 
                    ...
                    className={cn(
                      ...
                      field.value ? "bg-primary/5 border-primary shadow-sm" : "bg-background border-border hover:border-primary/50 hover:bg-muted"
                    )}
                  >
            ...
            <Controller
              ...
              render={({ field }) => (
                <label 
                  ...
                  className={cn(
                    "flex items-start space-x-3 p-3 rounded-xl border cursor-pointer transition-all duration-200 group relative overflow-hidden",
                    field.value ? "bg-emerald-500/5 border-emerald-500 shadow-sm" : "bg-background border-border hover:border-emerald-500/50 hover:bg-muted"
                  )}
                >
          ...
          <Card className="p-5 border-border bg-muted shadow-inner">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-sm">
                ...
                <span className="font-bold bg-background border border-border px-2 py-0.5 rounded text-foreground">{selectedStudents.length}</span>
              </div>
              <div className="flex justify-between items-center text-sm">
