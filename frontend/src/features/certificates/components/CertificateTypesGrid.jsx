...
function TypeSection({ title, description, types, loading, icon: HeaderIcon }) {
  ...
  return (
    <div className="space-y-6 bg-background rounded-xl border border-border/50 shadow-sm p-6 relative overflow-hidden">
  ...
  if (loading) {
    return (
      <div className="space-y-6 animate-in fade-in duration-300">
        {[1, 2].map((i) => (
          <div key={i} className="bg-background rounded-xl border border-border/50 p-6 space-y-6">
