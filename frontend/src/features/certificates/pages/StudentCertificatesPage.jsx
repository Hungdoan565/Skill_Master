              ...
              <div className="bg-muted/30 p-6 border-b border-border relative overflow-hidden">
                ...
                <SheetHeader className="relative z-10 space-y-4">
                  <div className="flex justify-between items-start gap-4">
                    <div className="h-14 w-14 rounded-xl bg-card border border-border shadow-sm flex items-center justify-center shrink-0">
                  ...
                  <div>
                    ...
                    {selected.certificate_number && (
                      <p className="font-mono text-sm text-muted-foreground mt-2 bg-card border border-border px-2 py-1 rounded-md inline-block">
                        {selected.certificate_number}
                      </p>
                    )}
                  </div>
              ...
              <div className="p-6 space-y-6 flex-1">
                ...
                <div className="flex flex-col gap-3 pt-4 mt-auto">
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => handleCopyLink(selected)} className="flex-1 h-10 border-border bg-card hover:bg-muted text-foreground">
                      <Share2 className="h-4 w-4 mr-2" /> Chia sẻ link
                    </Button>
                    
                    {selected.external_verify_url && (
                      <Button variant="outline" onClick={() => window.open(selected.external_verify_url, '_blank')} className="flex-1 h-10 border-border bg-card hover:bg-muted text-foreground">
