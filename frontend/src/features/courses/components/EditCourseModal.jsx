/**
 * EditCourseModal Component - Modal chỉnh sửa khóa học với Tab UI
 */
                    ...
                    <div className="flex items-center justify-between gap-3 px-6 py-4 border-t bg-neutral-50">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <Button
                                type="submit"
                                disabled={loading}
                                className="bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white min-w-[140px]"
                            >
                                {loading ? (
                                    <>
