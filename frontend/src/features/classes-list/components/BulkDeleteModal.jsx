    ...
    >
      ...
      <div className="relative bg-white rounded-xl shadow-xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <div className="p-6">
          ...
          <div className="mt-4 max-h-40 overflow-y-auto rounded-lg bg-slate-50 border border-slate-200 p-3">
              ...
              {selectedIds.slice(0, 5).map(id => {
                ...
                return cls ? (
                  <div key={id} className="flex items-center gap-2 text-sm">
                    ...
                    <span className="text-slate-400">({cls.code})</span>
                  </div>
                ) : null;
              })}
          ...
          <div className="mt-4 p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-2">
            ...
            <p className="text-sm text-amber-700">
              <span className="font-medium">Lưu ý:</span> Các lớp có học viên đang ghi danh sẽ không thể xóa.
            </p>
          </div>
        </div>
