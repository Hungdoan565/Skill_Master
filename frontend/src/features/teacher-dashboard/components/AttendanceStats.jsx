    ...
    return (
        <div className="rounded-2xl border border-border bg-card/95 p-6 shadow-sm shadow-black/5 dark:shadow-black/20">
            <div className="flex items-center justify-between mb-6">
                ...
                {monthly_trend && (
                    <div className="flex items-center gap-1 text-sm">
                        ...
                        <span className={cn(
                            monthly_trend >= 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400'
                        )}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="flex flex-col items-center justify-center rounded-lg bg-muted/40 p-4 dark:bg-muted/20">
                ...
                <div className="space-y-3">
                    <h4 className="text-sm font-medium text-foreground">Theo lớp học</h4>
                    {by_class.length === 0 ? (
