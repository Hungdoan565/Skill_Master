...
const accentMap = [
    { bg: 'bg-red-50', iconBg: 'bg-red-100', iconColor: 'text-red-600', border: 'hover:border-red-200' },
    { bg: 'bg-amber-50', iconBg: 'bg-amber-100', iconColor: 'text-amber-600', border: 'hover:border-amber-200' },
    { bg: 'bg-blue-50', iconBg: 'bg-blue-100', iconColor: 'text-blue-600', border: 'hover:border-blue-200' },
];
...
export const ProblemSection = () => {
    ...
    return (
        <>
            <section ref={ref} className="py-28 lg:py-32 bg-[#fdf9f2] overflow-hidden">
                    ...
                    <div className={`text-center max-w-3xl mx-auto transform transition-all duration-700
                      ${isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                        ...
                        <h2 className="font-display text-4xl lg:text-5xl font-bold text-zinc-900 tracking-tight">
                            ...
                            <br />
                            <span className="text-zinc-400">khi học Anh ngữ & Tin học?</span>
                        </h2>
                    </div>
                        ...
                        {painPoints.map((point, index) => {
                            ...
                            return (
                                <div
                                    ...
                                    ${accent.border} hover:shadow-xl hover:shadow-stone-200/50
                                ...
                                >
                                    ...
                                    <div className="flex items-start gap-4 mb-6">
                                        ...
                                        <span className="text-6xl font-display font-bold text-stone-100 leading-none select-none
                                            group-hover:text-stone-200 transition-colors">
