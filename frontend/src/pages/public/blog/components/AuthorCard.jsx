...
export const AuthorCard = ({ author, postCount = 12 }) => {
    ...
    return (
        <section className="py-12 border-t border-b border-stone-200 my-12">
            <div className="flex flex-col md:flex-row gap-8 items-start">
                ...
                <div className="flex-1">
                    ...
                    {/* Role */}
                    <p className="text-zinc-500 mb-4">{author.role}</p>
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        ...
                        <Link
                            ...
                            className="group flex items-center gap-2 text-sm font-medium text-zinc-600 
